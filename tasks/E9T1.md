# E9T1 — Implement compact time slot grid layout

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 DKB

Replace linear list of 15-minute time buttons with a grid layout showing hours (10-22) with collapsible minute options. Show only available time slots grouped by hour, with expandable/collapsible sections to reduce vertical space usage. Maintain 15-minute granularity but optimize visual density.

## Skills

**Skills:** telegram-bot-basics, UI-optimization
